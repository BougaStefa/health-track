...
public class DoctorDAO {
    ...
    public void addDoctor(Doctor doctor) throws SQLException {
        ...
        if (doctor instanceof Specialist) {
            sql = "INSERT INTO Doctor (doctorID, firstname, surname, address, email, hospital, specialization) VALUES (?, ?, ?, ?, ?, ?, ?)";
        } else {
    ...
    public void updateDoctor(Doctor doctor) throws SQLException {
        String sql;
        if (doctor instanceof Specialist) {
            sql = "UPDATE Doctor SET firstname = ?, surname = ?, address = ?, email = ?, hospital = ?, specialization = ? WHERE doctorID = ?";
        } else {
